...
var (
	badgePassing = Badge{width: 88, fillColor: `#44cc11`, status: `passing`, badgeText: `build`}
	badgeFailing = Badge{width: 80, fillColor: `#e05d44`, status: `failing`, badgeText: `build`}
	badgeUnknown = Badge{width: 98, fillColor: `#9f9f9f`, status: `unknown`, badgeText: `build`}
	badgeAborted = Badge{width: 90, fillColor: `#8f4b2d`, status: `aborted`, badgeText: `build`}
	badgeErrored = Badge{width: 88, fillColor: `#fe7d37`, status: `errored`, badgeText: `build`}
)
...
func (b *Badge) getBadgeText() string {
	// TODO BY ZOE
...
<svg xmlns="http://www.w3.org/2000/svg" width="{{ .Width }}" height="20">
   ...
   <g fill="#fff" text-anchor="middle" font-family="DejaVu Sans,Verdana,Geneva,sans-serif" font-size="11">
      <text x="18.5" y="15" fill="#010101" fill-opacity=".3">{{ .BadgeText }}</text>
