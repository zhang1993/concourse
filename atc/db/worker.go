...
func (worker *worker) BaggageclaimPeerURL() *string { return worker.baggageclaimPeerURL }
func (worker *worker) Zone() *string                { return worker.zone }
