...
type ResourceInstance interface {
	...
	FindOn(lager.Logger, worker.Worker) (worker.Artifact, bool, error)
}
...
func (instance resourceInstance) FindOn(logger lager.Logger, w worker.Worker) (worker.Artifact, bool, error) {
