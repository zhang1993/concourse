...
type FakeBuildPlanner struct {
	CreateStub        func(atc.StepConfig, atc.ResourceConfigs, atc.VersionedResourceTypes, []db.BuildInput) (atc.Plan, error)
...
func (fake *FakeBuildPlanner) Create(arg1 atc.StepConfig, arg2 atc.ResourceConfigs, arg3 atc.VersionedResourceTypes, arg4 []db.BuildInput) (atc.Plan, error) {
...
func (fake *FakeBuildPlanner) CreateCalls(stub func(atc.StepConfig, atc.ResourceConfigs, atc.VersionedResourceTypes, []db.BuildInput) (atc.Plan, error)) {
	fake.createMutex.Lock()
	defer fake.createMutex.Unlock()
	fake.CreateStub = stub
}

func (fake *FakeBuildPlanner) CreateArgsForCall(i int) (atc.StepConfig, atc.ResourceConfigs, atc.VersionedResourceTypes, []db.BuildInput) {
	fake.createMutex.RLock()
	defer fake.createMutex.RUnlock()
