...
type FakeImageFactory struct {
	GetImageStub        func(lager.Logger, worker.Worker, worker.ImageSpec, int, worker.ImageFetchingDelegate, creds.VersionedResourceTypes) (worker.Image, error)
	getImageMutex       sync.RWMutex
	getImageArgsForCall []struct {
		arg1 lager.Logger
		arg2 worker.Worker
		arg3 worker.ImageSpec
		arg4 int
		arg5 worker.ImageFetchingDelegate
...
func (fake *FakeImageFactory) GetImage(arg1 lager.Logger, arg2 worker.Worker, arg3 worker.ImageSpec, arg4 int, arg5 worker.ImageFetchingDelegate, arg6 creds.VersionedResourceTypes) (worker.Image, error) {
	...
	fake.recordInvocation("GetImage", []interface{}{arg1, arg2, arg3, arg4, arg5, arg6})
	fake.getImageMutex.Unlock()
	if fake.GetImageStub != nil {
		return fake.GetImageStub(arg1, arg2, arg3, arg4, arg5, arg6)
	}
	if specificReturn {
...
func (fake *FakeImageFactory) GetImageCalls(stub func(lager.Logger, worker.Worker, worker.ImageSpec, int, worker.ImageFetchingDelegate, creds.VersionedResourceTypes) (worker.Image, error)) {
	fake.getImageMutex.Lock()
	defer fake.getImageMutex.Unlock()
	fake.GetImageStub = stub
}

func (fake *FakeImageFactory) GetImageArgsForCall(i int) (lager.Logger, worker.Worker, worker.ImageSpec, int, worker.ImageFetchingDelegate, creds.VersionedResourceTypes) {
	fake.getImageMutex.RLock()
	defer fake.getImageMutex.RUnlock()
